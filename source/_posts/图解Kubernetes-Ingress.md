---
title: 图解Kubernetes Ingress
author: 张权
top: false
cover: false
toc: true
mathjax: true
date: 2022-08-21 22:40:56
password:
summary: 图解Kubernetes Ingress
tags: Kubernetes
categories: Kubernetes
---

# 图解Kubernetes Ingress
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/k8s-ingress-1.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/k8s-ingress-2.png)
...
在 Kubernetes 中部署应用后，我们应该先去了解 Kubernetes Service 服务。比如我们有两个 worker 节点，有两个服务 **service-nginx** 和 **service-python**，它们指向不同的 pods。这两个服务没有被调度到任何特定的节点上，也就是在任何节点上都有可能，如下图所示：

![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/k8s-ingress-3.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/k8s-ingress-4.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/k8s-ingress-5.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/k8s-ingress-6.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/k8s-ingress-7.png)

我们可以看到一个正常的 LoadBalancer 服务，有一个外部 IP 和一个所属的 pod，我们可以使用命令 `kubectl exec` 进入该 pod，里面包含一个预配置的 Nginx 服务器。

![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/k8s-ingress-8.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/k8s-ingress-9.png)

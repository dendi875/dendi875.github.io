---
title: Java并发编程—Thread-Per-Message模式：最简单实用的分工方法
author: 张权
top: false
cover: false
toc: true
mathjax: false
date: 2023-08-03 18:07:13
password:
summary: Java并发编程—Thread-Per-Message模式：最简单实用的分工方法
tags:
	- Java
	- 并发编程
categories: Java并发编程
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230803180337.png)
...
Thread-Per-Message 模式在实现的时候需要注意是否存在线程的频繁创建、销毁以及是否可能导致 OOM。在高并发场景中，最简单的办法其实是限流。

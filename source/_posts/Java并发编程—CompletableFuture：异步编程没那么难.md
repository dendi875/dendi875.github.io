---
title: Java并发编程—CompletableFuture：异步编程没那么难
author: 张权
top: false
cover: false
toc: true
mathjax: false
date: 2023-07-07 11:23:03
password:
summary: Java并发编程—CompletableFuture：异步编程没那么难
tags:
	- Java
	- 并发编程
categories: Java并发编程
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230706113537.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230706115213.png)

​																										   串行关系

![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230706115305.png)

​																											 并行关系

![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230706115358.png)
...
答：findRuleByJdbc() 这个方法隐藏着一个阻塞式 I/O，这意味着会阻塞调用线程。默认情况下所有的 CompletableFuture 共享一个 ForkJoinPool，当有阻塞式 I/O 时，可能导致所有的 ForkJoinPool 线程都阻塞，进而影响整个系统的性能。所以应该放在单独线程池，避免线程饥饿。

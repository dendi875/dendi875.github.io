---
title: Kafka-Kafka线上集群部署方案怎么做？
author: 张权
top: false
cover: false
toc: true
mathjax: false
date: 2024-07-04 20:04:06
password:
summary: Kafka-Kafka线上集群部署方案怎么做？
tags:
  - Kafka
  - 消息队
categories: Kafka
...
好了，有了 240Mbps，我们就可以计算 1 小时内处理 1TB 数据所需的服务器数量了。根据这个目标，我们每秒需要处理 `1024 * *1024 / 3600*8 = 2336Mb`， 的数据，除以 240，约等于 10 台服务器。如果消息还需要额外复制两份，那么总的服务器台数还要乘以 3，即 30 台。
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/deploy.png)

---
title: Java并发编程—Semaphore：如何快速实现一个限流器？
author: 张权
top: false
cover: false
toc: true
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230628183603.png)
...
答：Semaphore 可以允许多个线程访问一个临界区，那就意味着可能存在多个线程同时访问 ArrayList，而 ArrayList 不是线程安全的，所以对象池的例子中是不能够将 Vector 换成 ArrayList 的。Semaphore 允许多个线程访问一个临界区，这也是一把双刃剑，当多个线程进入临界区时，如果需要访问共享变量就会存在并发问题，所以必须加锁，也就是说 Semaphore 需要锁中锁。
...
* https://medium.com/@nohanomier/java-multithreading-semaphores-9396b3f4a813
* https://neha-gupta.medium.com/java-concurrency-using-semaphores-615d30f34fd4
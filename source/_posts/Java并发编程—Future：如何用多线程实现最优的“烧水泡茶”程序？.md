---
title: Java并发编程—Future：如何用多线程实现最优的“烧水泡茶”程序？
author: 张权
top: false
cover: false
toc: true
mathjax: false
date: 2023-07-05 10:18:29
password:
summary: Java并发编程—Future：如何用多线程实现最优的“烧水泡茶”程序？
tags:
	- Java
	- 并发编程
categories: Java并发编程
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230704170217.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/烧水泡茶最优分工方案 .png)
...
答：用 `ThreadPoolExecutor + Future`优化。
...
* https://github.com/aliakh/demo-java-concurrency-parallelism/tree/master/src/main/java/demo/part12_future

---
title: Java并发编程— 一不小心就死锁了，怎么办？
author: 张权
top: false
cover: false
toc: true
mathjax: false
date: 2023-06-14 12:02:46
password:
summary: Java并发编程— 一不小心就死锁了，怎么办？
tags:
	- Java
	- 并发编程
categories: Java并发编程
...
在[上一篇文章](https://zhangquan.me/2023/06/13/java-bing-fa-bian-cheng-hu-chi-suo-xia-ru-he-yong-yi-ba-suo-bao-hu-duo-ge-zi-yuan/)中，我们用 Account.class 作为互斥锁，来解决银行业务里面的转账问题，虽然这个方案不存在并发问题，但是所有账户的转账操作都是串行的，例如账户 A 转账户 B、账户 C 转账户 D 这两个转账操作现实世界里是可以并行的，但是在这个方案里却被串行化了，这样的话，性能太差。
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230614095921.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230614112142.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230614112342.png)
...
其中，互斥这个条件我们没有办法破坏，因为我们用锁的目的就是互斥。不过其他三个条件都是有办法破坏掉的，到底如何做呢？
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230614112840.png)

---
title: Java并发编程—用“等待-通知”机制优化循环等待
author: 张权
top: false
cover: false
toc: true
...
由[上一篇文章](https://zhangquan.me/2023/06/14/java-bing-fa-bian-cheng-yi-bu-xiao-xin-jiu-si-suo-liao-zen-me-ban/)你应该已经知道，在**破坏占用且等待条件**的时候，如果转出账本和转入账本不满足同时在文件架上这个条件，就用死循环的方式来循环等待，核心代码如下：
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230614114354.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230614114606.png)

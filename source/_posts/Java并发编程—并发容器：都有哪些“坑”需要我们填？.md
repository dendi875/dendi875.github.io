---
title: Java并发编程—并发容器：都有哪些“坑”需要我们填？
author: 张权
top: false
cover: false
toc: true
mathjax: false
date: 2023-07-03 13:32:46
password:
summary: Java并发编程—并发容器：都有哪些“坑”需要我们填？
tags:
	- Java
	- 并发编程
categories: Java并发编程
...
在[Java并发编程—如何用面向对象思想写好并发程序？](https://zhangquan.me/2023/06/16/java-bing-fa-bian-cheng-ru-he-yong-mian-xiang-dui-xiang-si-xiang-xie-hao-bing-fa-cheng-xu/)我们讲过实现思路其实很简单，只要把非线程安全的容器封装在对象内部，然后控制好访问路径就可以了。
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230630154307.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/concurrentCollections-List1.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/concurrentCollections-List2.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230630154703.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230630155007.png)
...
![](https://cdn.jsdelivr.net/gh/dendi875/images/PicGo/20230630155142.png)
